...
export const frenchCrmMessages = {
  ...
  crm: {
    ...
    auth: {
      ...
      welcome_title: "Bienvenue sur Neon CRM",
    },
    common: {
      activity: "Activité",
      added: "ajoutée",
    ...
    profile: {
      inbound: {
        description:
          "Vous pouvez commencer à envoyer des e-mails vers l'adresse de réception de votre serveur, par exemple en l'ajoutant au champ %{field}. Neon CRM traitera les e-mails et ajoutera des notes aux contacts correspondants.",

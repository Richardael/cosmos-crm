...
const nivoTheme = {
  ...
  text: { fill: "#a0a0a0", fontSize: 12 },
  axis: {
    ticks: { text: { fill: "#a0a0a0", fontSize: 11 } },
    legend: { text: { fill: "#a0a0a0" } },
  },
  grid: { line: { stroke: "#2e2e2e", strokeWidth: 1 } },
  tooltip: {
    container: {
      background: "#111111",
      color: "#fafafa",
        ...
        <div style={{ height: chartData.length * 48 + 24 }}>
          <ResponsiveBar
            ...
            tooltip={({ indexValue, value }) => (
              <div className="px-3 py-1.5 text-sm bg-card border border-border rounded shadow">

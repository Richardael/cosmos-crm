 ...
 * import { CRM } from '@/components/neon-crm/dashboard/CRM';
 *
 * const App = () => (
 *     <CRM
...
export const CRM = ({
  ...
  useEffect(() => {
    ...
    const img = new Image();
    img.src = `https://atomic-crm-telemetry.marmelab.com/atomic-crm-telemetry?domain=${window.location.hostname}&app=neon-crm`;
  }, [disableTelemetry]);

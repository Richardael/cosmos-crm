...
export const spanishCrmMessages: PartialCrmMessages & typeof raSupabaseSpanishMessages & typeof raCoreOverrides = {
  ...
  crm: {
    ...
    auth: {
      ...
      welcome_title: "Bienvenido a CosmosCRM",
    },
    common: {
      activity: "Actividad",
      added: "registrado",
    ...
    profile: {
      inbound: {
        description:
          "Puedes comenzar a enviar correos a la dirección de correo entrante de tu servidor, por ejemplo agregándola al campo %{field}. CosmosCRM procesará los correos y agregará notas a los contactos correspondientes.",

        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              className="border border-border rounded-md px-3 py-2 bg-surface text-ghost text-sm focus:outline-none focus:ring-1 focus:ring-emerald"
          ...
          <div className="flex gap-4">
            <div className="flex flex-col gap-1 flex-1">
              ...
              <div className="flex items-center gap-2">
                ...
                <input
                  {...register("color")}
                  className="border border-border rounded-md px-3 py-2 bg-surface text-ghost text-sm flex-1 focus:outline-none focus:ring-1 focus:ring-emerald"
                  placeholder="#9CA3AF"
                />
              </div>
            </div>
